...
const backgroundCardRef = useRef<cardRefElement>(null);
  ...
  return (
    <section id="parallax-section" className="relative py-2xl px-md md:px-2xl flex flex-col md:flex-row h-screen md:h-[867px] items-center justify-start md:justify-between bg-gradient-to-br from-neutral-900 to-primary-900 md:rounded-4xl">
